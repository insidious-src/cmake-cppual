...
macro(_XCB_HANDLE_COMPONENT _comp)
    ...
    find_package_handle_standard_args(XCB_${_comp}
        REQUIRED_VARS XCB_${_comp}_LIBRARY XCB_${_comp}_INCLUDE_DIR NAME_MISMATCHED)

    if(XCB_${_comp}_FOUND AND NOT TARGET XCB_${_comp}::Library)
            add_library(XCB_${_comp}::Library UNKNOWN IMPORTED)
            set_target_properties(XCB_${_comp}::Library PROPERTIES
